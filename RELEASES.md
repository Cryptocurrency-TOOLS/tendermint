...
branches tags. See [#6072](https://github.com/Cryptocurrency-TOOLS/tendermint/pull/6072)
for more context.
...
4. Create a PR to update the documentation directory for the backport branch.
   ...
   * `https://github.com/Cryptocurrency-TOOLS/tendermint/blob/main/LICENSE`
   ...
   * `github.com/Cryptocurrency-TOOLS/tendermint/blob/main` ->
     `github.com/Cryptocurrency-TOOLS/tendermint/blob/v0.38.x`
   * `github.com/Cryptocurrency-TOOLS/tendermint/tree/main` ->
     `github.com/Cryptocurrency-TOOLS/tendermint/tree/v0.38.x`
...
2. Add a new section to the Mergify config (`.github/mergify.yml`) to enable the
   ...
   [label](https://github.com/Cryptocurrency-TOOLS/tendermint/labels) so the bot can be triggered.
...
[e2e]: https://github.com/Cryptocurrency-TOOLS/tendermint/blob/main/.github/workflows/e2e-nightly-main.yml
...
2. Run the integration tests and the E2E nightlies
   ...
   e.g., https://github.com/Cryptocurrency-TOOLS/tendermint/actions/workflows/e2e-nightly-37x.yml).
...
tests](https://github.com/Cryptocurrency-TOOLS/tendermint/blob/main/test/e2e/README.md#L1)
